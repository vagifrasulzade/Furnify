...
export default function Kitchen() {
    ...
    return filtered;
    }, [searchTerm, priceRange, sortBy, minRating, selectedCategory, kitchenProducts]);

    return (
        <div className='py-16 bg-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center mb-12'>
                    <h1 className='text-4xl font-bold text-gray-900 mb-4'>Kitchen Furniture</h1>
                    <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
                        Organize and enhance your kitchen with our functional furniture pieces
                    </p>
                </div>
