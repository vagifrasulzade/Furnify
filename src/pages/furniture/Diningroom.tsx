...
export default function DiningRoom() {
    ...
    const [selectedCategory, setSelectedCategory] = useState<string>('dining-room');
    ...
    // Start with all products or dining room products based on selection
    let baseProducts = selectedCategory === 'all' ? products : 
                      selectedCategory === 'dining-room' ? diningRoomProducts :
    ...
    return filtered;
    }, [searchTerm, priceRange, sortBy, minRating, selectedCategory, diningRoomProducts]);

    return (
        <div className='py-16 bg-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center mb-12'>
                    <h1 className='text-4xl font-bold text-gray-900 mb-4'>Dining Room Furniture</h1>
                    <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
                        Create memorable dining experiences with our elegant dining room collection
                    </p>
                </div>
