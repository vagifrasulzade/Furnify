...
export default function Sofa() {
    ...
    const [selectedCategory, setSelectedCategory] = useState<string>('sofa');
    ...
    // Start with all products or sofa products based on selection
    let baseProducts = selectedCategory === 'all' ? products : 
                      selectedCategory === 'sofa' ? sofaProducts :
    ...
    return filtered;
    }, [searchTerm, priceRange, sortBy, minRating, selectedCategory, sofaProducts]);

    return (
        <div className='py-16 bg-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center mb-12'>
                    <h1 className='text-4xl font-bold text-gray-900 mb-4'>Sofa Furniture</h1>
                    <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
                        Discover comfort and style with our premium sofa collection
                    </p>
                </div>
