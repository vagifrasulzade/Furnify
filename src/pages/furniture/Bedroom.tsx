...
export default function Bedroom() {
    ...
    // Start with all products or bedroom products based on selection
    let baseProducts = selectedCategory === 'all' ? products : 
                      selectedCategory === 'bedroom' ? bedroomProducts :
    ...
    return filtered;
    }, [searchTerm, priceRange, sortBy, minRating, selectedCategory, bedroomProducts]);

    return (
        <div className='py-16 bg-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center mb-12'>
                    <h1 className='text-4xl font-bold text-gray-900 mb-4'>Bedroom Furniture</h1>
                    <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
                    Create your perfect bedroom sanctuary with our comfortable and stylish furniture collection
                    </p>
                </div>
