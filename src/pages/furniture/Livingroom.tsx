...
export default function LivingRoom() {
    ...
    // Start with all products or living room products based on selection
    let baseProducts = selectedCategory === 'all' ? products : 
                      selectedCategory === 'living-room' ? livingRoomProducts :
    ...
    return filtered;
    }, [searchTerm, priceRange, sortBy, minRating, selectedCategory, livingRoomProducts]);

    return (
        <div className='py-16 bg-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center mb-12'>
                    <h1 className='text-4xl font-bold text-gray-900 mb-4'>Living Room Furniture</h1>
                    <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
                        Transform your living space with our modern and comfortable furniture pieces
                    </p>
                </div>
