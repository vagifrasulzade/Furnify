...
export default function AllProducts() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    let filtered = products.filter(product => {
      ...
      if (minRating > 0) {
        console.log(`Product: ${product.name}, Rating: ${product.rating}, MinRating: ${minRating}, Matches: ${matchesRating}`);
      }
    ...
    return filtered;
  }, [searchTerm, selectedCategory, priceRange, sortBy, minRating]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            Explore our wide range of products designed to enhance your living space with style and comfort.
          </p>
        </div>
